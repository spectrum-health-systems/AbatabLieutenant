...
namespace AbatabLieutenant.Deployment
{
    ...
    internal static class Download
    {
        ...
        public static void FromUrl(string requestedBranch, string branchUrl, string stagingDirectory, string logFileName)
        {
            ...
            InterWeb.Downloader.FromUrl(branchUrl, $"{stagingDirectory}/Abatab-{requestedBranch}.zip");
        }
    }
}